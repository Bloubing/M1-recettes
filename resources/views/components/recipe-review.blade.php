<div class="mt-3 flex space-x-2">
    <svg class="mt-[0.1rem] w-5 h-5 text-yellow-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
    ...
    @if ($recipe->ratings->count() > 0)
        <p class="font-medium">({{ $recipe->averageRating() }}/5) - {{ $recipe->ratings->count() }} avis </p>
    @else
        <p class="font-medium"> Aucun avis</p>
    @endif
</div>
