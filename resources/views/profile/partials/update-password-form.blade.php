<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Veuillez entrer un mot de passe long et compliqué pour plus de sécurité') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password"
                class="mt-1 block w-full border-gray-900" autocomplete="current-password" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password" name="password" type="password"
                class="mt-1 block w-full border-gray-900" autocomplete="new-password" />
